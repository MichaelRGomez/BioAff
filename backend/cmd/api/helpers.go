// BIOAFF/backend/cmd/api/helpers.go
package main
...
// Defining a new type named envelope
type envelope map[string]interface {
}

// readIDParam() - finds the id paramter from inside a json formatted request
...
// writeJSON - allows us to push json formatted messages to the client user
...
// readJSON - convertss json formatted infromation into what the system can use
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	//using http.MaxBytes header() to limit the size of the request body to 1MB
	maxBytes := 1_048_576
	...
	if err != nil {
		...
		//using a switch to check the errors
		switch {
		//check for syntax
